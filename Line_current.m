...
R_25 = 7.283/10^5;   %Conductor AC resistance, Ohm/m
R_75 = 8.688/10^5;
Z1 = 90;             %Azimuth of line, relative to North: The line runs in an east to west direction
...
R = R_25 + (R_75 - R_25) / (75 - 25) * (Ts -25);                    %Resistandce at operating temperature, Ohm/m
I = sqrt((q_c + q_r - q_s) / R);                                   %Current, A
