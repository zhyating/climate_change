...
filename = "H:/Output_scenarios/2100/arw/wrfout_d04_2099-07-24_11_00_00.nc"
ncfile = Dataset(filename, mode='r')
filename2 = "H:/Output_scenarios/2100/ref/wrfout_d04_2099-07-24_11_00_00.nc"
ncfile2 = Dataset(filename2, mode='r')


# Extract the model height and wind speed
z = getvar(ncfile, "z")[0:11]
tc1 =  getvar(ncfile, "tc")[0:11]
tc2 =  getvar(ncfile2, "tc")[0:11]
...
ax.set_xticks(x_ticks[::35])
ax.set_xticklabels(x_labels[::35], fontsize=14)
...
plt.title("Vertical Cross Section of temperature ($^\circ$C)", {"fontsize" : 14})
