...
dura1 = np.loadtxt('C:/Users/Yating/Desktop/output/2001-2005Duration_out.txt')
...
cs = m.contourf(x, y, mdata, clevs, cmap='bwr', extend='both')
cbar = m.colorbar(cs, "right",size="5%", pad='2%')
cbar.set_label('Duration difference\n (days/event)')
plt.show()