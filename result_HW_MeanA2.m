        ...
        for i = 5:9          
            for k = 1:num(i-4)                 
                if k > 9
                    ...
                    filename15 = ['F:/Output files/2061-2065-d4/wrfout_d04_',num2str(year),'-0',num2str(i),'-',num2str(k),'_','15_00_00.nc'];
                    filename18 = ['F:/Output files/2061-2065-d4/wrfout_d04_',num2str(year),'-0',num2str(i),'-',num2str(k),'_','18_00_00.nc'];
                    filename21 = ['F:/Output files/2061-2065-d4/wrfout_d04_',num2str(year),'-0',num2str(i),'-',num2str(k),'_','21_00_00.nc'];
                else
                   
                    filename15 = ['F:/Output files/2061-2065-d4/wrfout_d04_',num2str(year),'-0',num2str(i),'-0',num2str(k),'_','15_00_00.nc'];
                    filename18 = ['F:/Output files/2061-2065-d4/wrfout_d04_',num2str(year),'-0',num2str(i),'-0',num2str(k),'_','18_00_00.nc'];
                    filename21 = ['F:/Output files/2061-2065-d4/wrfout_d04_',num2str(year),'-0',num2str(i),'-0',num2str(k),'_','21_00_00.nc'];
                end
